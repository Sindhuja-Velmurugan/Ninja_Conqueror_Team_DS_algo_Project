...
public class ArrayPage {
	...
	public void userlogin() throws IOException {
		...
		File src = new File(
				"C:\\Users\\User\\eclipse-workspace\\Ninja_Conqueror_DS_Algo_Project\\src\\test\\resources\\testdata\\Testdataforusername.xlsx");
...

	{
		...
		File src = new File(
				"C:\\Users\\User\\eclipse-workspace\\Ninja_Conqueror_DS_Algo_Project\\src\\test\\resources\\testdata\\TestdataforSPC.xlsx");
		FileInputStream finput = new FileInputStream(src);
		workbook = new XSSFWorkbook(finput);
		sheet = workbook.getSheetAt(0);
...
public void codeforsearcharray() throws IOException, InterruptedException {
	...
	Actions action = new Actions(driver);
	 ...
	 File src=new File("C:\\Users\\User\\eclipse-workspace\\Ninja_Conqueror_DS_Algo_Project\\src\\test\\resources\\testdata\\Testdataforqn1.xlsx");
	FileInputStream finput=new FileInputStream(src);
	workbook=new XSSFWorkbook(finput);
	sheet=workbook.getSheetAt(0);
	...
	public void codeformaxconservno() throws IOException, InterruptedException {
		...
		File src = new File(
				"C:\\Users\\User\\eclipse-workspace\\Ninja_Conqueror_DS_Algo_Project\\src\\test\\resources\\testdata\\Testdata.xlsx");
		FileInputStream finput = new FileInputStream(src);
		workbook = new XSSFWorkbook(finput);
	...
	public void codeforoddoreven() throws IOException, InterruptedException {
		...
		File src = new File(
				"C:\\Users\\User\\eclipse-workspace\\Ninja_Conqueror_DS_Algo_Project\\src\\test\\resources\\testdata\\Testdataforqn3.xlsx");
		FileInputStream finput = new FileInputStream(src);
		workbook = new XSSFWorkbook(finput);
		sheet = workbook.getSheetAt(0);
	...
	public void codeforsortedSqauare() throws IOException, InterruptedException {
		...
		File src = new File(
				"C:\\Users\\User\\eclipse-workspace\\Ninja_Conqueror_DS_Algo_Project\\src\\test\\resources\\testdata\\Testdataforqn4.xlsx");
		FileInputStream finput = new FileInputStream(src);
		workbook = new XSSFWorkbook(finput);
		sheet = workbook.getSheetAt(0);
...
public void TryeditorPage() {
	...
	public void invalidpythoncode() throws InterruptedException, IOException {

		{
			...
			File src = new File(
					"C:\\Users\\User\\eclipse-workspace\\Ninja_Conqueror_DS_Algo_Project\\src\\test\\resources\\testdata\\InvalidTestdata.xlsx");
			FileInputStream finput = new FileInputStream(src);
			workbook = new XSSFWorkbook(finput);
			sheet = workbook.getSheetAt(0);
...
public void Capture_ScreenShot() throws AWTException, IOException {
		...
		File DestinationFile = new File("C:\\Users\\User\\eclipse-workspace\\Ninja_Conqueror_DS_Algo_Project\\src\\test\\resources\\ScreenShots\\ArrayPage.png");
